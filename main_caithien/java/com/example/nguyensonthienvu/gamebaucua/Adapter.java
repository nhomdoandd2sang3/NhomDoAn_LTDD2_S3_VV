...
public class Adapter extends ArrayAdapter<String> {
    ...
    public View getView(int position,  View convertView,  ViewGroup parent) {
        ...
        //cho adepter b iet do ma mau string vao layout item_kukube
        row=inflater.inflate(R.layout.item_kukube,null);
        if(arr!=null&&arr.size()>0){
            com.example.nguyensonthienvu.gamebaucua.textView a=(com.example.nguyensonthienvu.gamebaucua.textView)row.findViewById(R.id.item);
