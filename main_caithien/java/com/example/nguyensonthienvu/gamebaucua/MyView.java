...
public class MyView extends View{
    ...
    public MyView(Context context, AttributeSet attrs)
    {
        ...
        m_BitmapBg  = getResBitmap(R.drawable.denthui);
    ...
    {
        m_nCol = ( getWidth()-2*MARGIN)/m_nCellSize;
        m_nRow = ( getHeight()-2*MARGIN)/m_nCellSize;
            ...
            try{
                ...
                if(nCurX <= m_rectTable.right && nCurX>= m_rectTable.left && nCurY <= m_rectTable.bottom && nCurY>= m_rectTable.top )
                {
                    ...
                    if(TestGameFinish(m_matrixState, m_nRow, m_nCol)==true)
                    {
                        ...
                        saveDialog.setMessage("Bạn có muốn chơi lại?");
